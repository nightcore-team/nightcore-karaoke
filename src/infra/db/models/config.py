...
class GuildPermissionsConfig(BaseIdTimeStampModel, GuildIdMixin):
    """Guild permissions configuration."""

    karaoke_config_access_roles_ids: Mapped[list[int] | None] = mapped_column(
